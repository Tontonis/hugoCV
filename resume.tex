...
Beam Dynamics, Wakefields and beam impedance, RF engineering, beam instrumentation, complex systems, numerical methods, nanotechnology, solid state physics
    ...
    \textbf{School of Physics and Astronomy, University of Manchester}, Manchester, United Kingdom \vspace{2mm}\\\vspace{1mm}%
    ...
    \textbf{School of Physics and Astronomy, University of Southampton}, Southampton, United Kingdom 
    \textsl{MPhys (Hons) Physics } \hfill \textbf{October 2005 -- July 2009}\vspace{-3mm}\\\vspace{-1mm}%
    \begin{list2}
        \item Classification: 1$^{\mathrm{st}}$ Class
        \item Masters' Thesis: Controlling the synthesis of branched gold nanoparticles using a wet chemical synthesis method 
        \item Supervisor: Dr Antonios Kanaras
    \end{list2}\vspace{-1.5mm}
